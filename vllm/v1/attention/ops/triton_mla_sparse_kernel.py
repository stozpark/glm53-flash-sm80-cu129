...
# DeepSeek-V3.2 sparse MLA has 512 latent lanes plus 64 RoPE lanes. GLM-5.3
# uses the same 512 latent lanes without the RoPE suffix.
_BLOCK_DMODEL = 512
_BLOCK_DPE = 64
_BLOCK_DV = 512
_DIM_QK = _BLOCK_DMODEL + _BLOCK_DPE  # 576
_SUPPORTED_DIM_QK = (_BLOCK_DMODEL, _DIM_QK)
