...
class XPUMLASparseImpl(MLAAttentionImpl[XPUMLASparseMetadata]):
    ...
    def forward_mqa(
        ...
        topk_indices_global = triton_convert_req_index_to_global_index(
            ...
            # KPool appends up to pool_size - 1 recent tail tokens and pads
            # the shared buffer to the sparse kernel tile width. Preserve that
            # actual width here; padded -1 entries remain masked downstream.
