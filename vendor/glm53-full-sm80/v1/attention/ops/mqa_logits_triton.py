...
def _fp8_paged_mqa_logits_kernel(
    ...
    # Unified KV pools can have very large per-block strides.  Cast the
    # physical block id before multiplying by the byte/element stride; doing
    # this in int32 can silently wrap at long context on SM80.
    block_idx = tl.load(
